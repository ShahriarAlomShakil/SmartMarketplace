...
export const useTooltip = (content: string, position: ModernTooltipProps['position'] = 'top') => {
  return {
...
interface SimpleTooltipProps {
  tooltip: string;
  position?: ModernTooltipProps['position'];
  children: React.ReactNode;
  className?: string;
}
...
export const SimpleTooltip: React.FC<SimpleTooltipProps> = ({
  ...
  return (
    <ModernTooltip content={tooltip} position={position} className={className}>
      {children}
    </ModernTooltip>
  );
};
...
export { ModernTooltip as GlassTooltip };
